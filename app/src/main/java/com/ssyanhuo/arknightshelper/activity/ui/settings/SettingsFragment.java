package com.ssyanhuo.arknightshelper.activity.ui.settings;
...
public class SettingsFragment extends PreferenceFragmentCompat {
    ...
    private void preNotifyThemeChanged(){
        getActivity().setTheme(ThemeUtils.getThemeId(ThemeUtils.THEME_UNSPECIFIED, ThemeUtils.TYPE_MAIN, getActivity().getApplicationContext()));
    }
    @Override
